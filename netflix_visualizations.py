...
plt.legend(labels)
plt.title('Revenue vs. Earnings per Share for the Four Quarters in 2017')

ax.set_xticks(middle_x)
ax.set_xticklabels(quarter_labels)
plt.show()
plt.savefig('netflix3.png')
...
# Both Revenue and Earnings follow a trend with earnings around 5% of revenue
